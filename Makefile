# AliReza OS Makefile
# based on Buildroot project
#
# Copyrught (C) 2014 by AliReza Forouzandeh Nezhad <alirezafn@gmx.us>
...
export AOS_VERSION_FULL := 3.5.0-git
export AOS_VERSION := 3.5.0
...
ifeq ($(BR2_TOOLCHAIN_HAS_THREADS),y)
	...
	( \
		echo "NAME=Alireza OS"; \
		echo "VERSION=$(AOS_VERSION_FULL)"; \
		echo "ID=alirezaos"; \
		echo "VERSION_ID=$(AOS_VERSION)"; \
		echo "PRETTY_NAME=\"Alireza OS $(BR2_VERSION)\"" \
...
release: OUT = AlirezaOS-$(AOS_VERSION)
...
release:
	...
	rm -rf $(OUT) $(OUT).tar
	cp output/images/rootfs.ext2 alirezaos-core.img
	zip alirezaos-core.zip alirezaos-core.img
	rm alirezaos-core.img

print-version:
	@echo $(AOS_VERSION_FULL)
